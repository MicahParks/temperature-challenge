...
Challenge: Modify the go code below to calculate the average temperature in the 100 largest cities in the United States
at the current time. Handle any errors if a city is missing temperature data and skip that city in the final
calculation.
